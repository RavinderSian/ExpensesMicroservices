...
import com.personal.expenses.model.BudgetAuthenticationFailureHandler;
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().formLogin() // no custom page so default is /login
				...
				.and().logout().logoutUrl("/logout") // url for default logout page
